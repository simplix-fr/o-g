<?php
	...
	$adaptive_done = get_post_meta($pid,'adaptive_done',true);
	if(!empty($adaptive_done)) { echo 'go back was paid already.'; exit; }
 ...
 //-------------------------------------------------------------------------	
	...
	$params = "feesPayer=EACHRECEIVER&actionType=PAY_PRIMARY&cancelUrl=".$ret."&trackingId=".$trID."&notify_url=".$notifyURL."&ipnNotificationUrl=".$notifyURL."&currencyCode=".$currency.
